...
export const TECH = [
  ...
  { name: "JavaScript", color: "#ffffff", dark: "#0f172a", icon: "🌊" },
  ...
  { name: "Express.js", color: "#E34F26", dark: "#1a1a1a", icon: "⬡" },
...
const ILLUS_MAP = {
  ...
  arjun: ["#dc2626", "#7f1d1d", "AK"], priya: ["#7c3aed", "#4c1d95", "KP"], ravi: ["#0284c7", "#0c4a6e", "HD"], hari: ["#7c3aed", "#4c1d95", "K"],
