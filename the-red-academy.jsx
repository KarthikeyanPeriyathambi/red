...
export const PROJECTS = [
  { name:"LUCA Digital Solutions", industry:"Digital Marketing", features:["SEO & SEM","Google Ads","Social Media","Responsive Design"], color:"#1e3a8a", bg:"#eff6ff", img:"luca" },
  { name:"HEALIX Dashboard",        industry:"Healthcare / Events", features:["Event Bookings","Revenue Tracking","VEG/Non-VEG Stats","Date Filters"], color:"#78350f", bg:"#fef3c7", img:"healix_dash" },
  { name:"HEALIX 2026 Conference",  industry:"Medical Conference", features:["Registration Flow","Schedule Viewer","Mobile First","Branding"], color:"#92400e", bg:"#fffbeb", img:"healix_conf" },
  { name:"CloudBees Tech Website",  industry:"IT / SaaS", features:["AI-Powered UI","ERP & CRM","Service Showcase","Lead Gen"], color:"#854d0e", bg:"#fefce8", img:"cloudbees" },
  { name:"HR 360°",                 industry:"HR Software", features:["Financial Planning","Employee Mgmt","Responsive Design","Dashboard"], color:"#0e7490", bg:"#ecfeff", img:"hr360" },
  { name:"ADININ Works",            industry:"Engineering / Construction", features:["Service Listing","Photo Gallery","Corporate Branding","Mobile Responsive"], color:"#374151", bg:"#f9fafb", img:"adinin" },
  { name:"Sri Venkateshwaraa CET",  industry:"Education", features:["Admission Enquiry","Course Selection","Apply Now","24/7 Chat"], color:"#1d4ed8", bg:"#eff6ff", img:"svcet" },
  { name:"SVMC Hospital",           industry:"Medical Education", features:["Admissions","360° View","Pay Now","Medical Research"], color:"#1e40af", bg:"#dbeafe", img:"svmc" },
  { name:"Le Pondy Kitchen",        industry:"Food & Restaurant", features:["Dark UI","Order Now","Menu Showcase","Brand Identity"], color:"#991b1b", bg:"#fef2f2", img:"lepondy" },
  { name:"Cloud Staffing Services", industry:"Home Services", features:["Service Showcase","Cleaning Packages","Lead Form","Brand Design"], color:"#1e3a8a", bg:"#eff6ff", img:"css" },
  { name:"CloudBees Products",      industry:"IT / SaaS", features:["CRM Showcase","ERP Products","Mobile + Desktop","Feature Bullets"], color:"#92400e", bg:"#fef9c3", img:"cb_products" },
  { name:"CbeezAI ERP & CRM",       industry:"AI / SaaS", features:["Multi-tenant ERP","AI Chat","WhatsApp Integration","Sales & HR"], color:"#111827", bg:"#f3f4f6", img:"cbeezai" },
  { name:"Bees2Ventures",           industry:"Tech Training", features:["DevOps Courses","Tech Solutions","Find Out More","Blue Gradient UI"], color:"#1d4ed8", bg:"#eff6ff", img:"bees2v" },
      ...
      <div className="bg-white rounded-3xl max-w-md w-full overflow-hidden shadow-2xl" onClick={e=>e.stopPropagation()}>
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3">
            <button className="flex-1 py-3 rounded-xl text-white font-bold text-sm" style={{background:project.color}}>
              View Case Study →
            </button>
